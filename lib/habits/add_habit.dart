  ...
  Widget build(BuildContext context) {
    return Skeleton(
      ...
      child: Column(children: <Widget>[
        ...[_title, _craving, _response, _reward, _behavior, _location].map(
          (e) => TextFormField(
            decoration: InputDecoration(
                hintText:
                    e.replaceAll("_", "").replaceAll(e[0], e[0].toUpperCase())),
            validator: (value) {
        ...
        DropdownButton<String>(
          items:
              HabitFreq.values.map<DropdownMenuItem<String>>((HabitFreq freq) {
